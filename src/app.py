...
activities.update({
    ...
    "Basketball Club": {
        "description": "Pickup games, drills, and intramural competition",
    ...
    "Drama Club": {
        "description": "Theater production, acting exercises, and stagecraft",
        "schedule": "Tuesdays and Thursdays, 5:00 PM - 7:00 PM",
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Problem solving and competition preparation for math contests",
